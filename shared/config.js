...
// API_BASE and BOND_API_KEY are injected at build time by scripts/inject-config.js.
// Driver auth uses per-user session tokens obtained at login — no static API token in client code.
// BOND_API_KEY is the admin API key for Eagle Eye and internal tooling only (not driver PWA).
(function(){
  ...
  C.BOND_API_KEY = window.__3LL_BOND_API_KEY || 'xUvzgCnQZ-j-0HYTh749E1t6AKX3RNYFqNfoNVcnH1Z0KFCQUy693Q';
